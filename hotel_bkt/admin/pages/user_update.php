<div class="col-sm-12"> <!-- menampilkan form add facility-->
    <section class="panel">
                    <div class="panel-body">
                        <a class="btn btn-compose" style="background-color: black; color: white">Update User</a>
                        <div class="box-body"	>
    ...
    <div class="form-group">
          ...
          <select required name="role" class="form-control">
            ...
            <option <?php if($data['role']==null) {echo "selected";} ?> value=''>Not Confirmed Visitor</option>  
          </select>
		  </div>
    </div>
		<div class="form-group">
