	        ...
	        <div class="panel-body">
				<table>
					<tbody  style='vertical-align:top;'>
						...
						<tr><td><b>Requirement</b></td> <td> :</td><td><?php echo $syarat ?></td></tr>
	...
	<div class="col-sm-6"> <!-- menampilkan peta-->
		<div class="row">
			<div class="col-sm-12"> <!-- menampilkan galeri-->
			    <section class="panel">
			        <div class="panel-body">
			        	<a class="btn btn-compose" style="background-color:black;border-bottom:1px solid black;color:white"> Picture of <?php echo $name_hotel ?></a>
			        	<div style="margin:0px; display:flex; justify-content:center" >
                        <div class="html5gallery" style="max-height:500px; display:block;" data-skin="horizontal" data-width="480" data-height="300" data-resizemode="fit">  
				    	<?php
							$id=$_GET['id'];
