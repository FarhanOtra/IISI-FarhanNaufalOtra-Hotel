<div class="col-sm-12"> <!-- menampilkan form add facility-->
    <section class="panel">
        <div class="panel-body">
            <a class="btn btn-compose" style="background-color: black; color: white; pointer-events:none">Add Facility</a>
        	<div class="box-body" >
				<?php  if (isset($_GET['id'])){
							$id=$_GET['id'];
							$sql = pg_query("SELECT * FROM facility_hotel where id='".$id."'");
