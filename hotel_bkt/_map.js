        var map;
        var server = "https://iisi-farhannaufalotra.herokuapp.com/hotel_bkt/";
...
{
  $('#tombol').empty();
  $('#tombol').append('<a type="button" id="hidelegenda" onclick="hideLegenda()" class="btn btn-success " data-toggle="tooltip" title="Sembunyikan Legenda" style="margin-right: 7px;"><i class="fa fa-eye-slash" style="color:white"></i></a> ');
  
  var layer = new google.maps.FusionTablesLayer(
    {
          query: {
            select: 'Location',
            from: 'AIzaSyA1TwYksj1uQg1V_5yPUZqwqYYtUIvidrY'
          },
          map: map
        });
...
function hideLegenda() {
  ...
  $('#tombol').append('<a type="button" id="showlegenda" onclick="legenda()" class="btn btn-success " data-toggle="tooltip" title="Legenda" style="margin-right: 7px;"><i class="fa fa-eye" style="color:white;"> </i></a>');
}
        ...
        function listHotel(){ // Menu Hotel
          ...
          { 
              for (var i in rows){ 
                ...
                $('#kanan_table').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' title='info'  onclick='data_hotel_1_info(\""+id+"\")'></a><a style='margin-left:10px' role='button' class='btn btn-success fa fa-taxi' title='Angkot' onclick='angkot_sekitar(\""+id+"\")'></a></td></tr>");  
      ...
      *********************************************************************************************************************************************************** */
      ...
      function ht_sekitar_user(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR USER
          ...
          $('#kanan_table').empty();
          document.getElementById('judul_table').innerHTML="Result";
          $('#kanan_table').append("<tr><th class='centered'>Hotel's Name</th><th class='centered' colspan='2'>Action</th></tr>");
      ...
      *********************************************************************************************************************************************************** */
      ...
      function cari_harga(){
        ...
        var min = document.getElementById('hmin').value;
        var max = document.getElementById('hmax').value;
        document.getElementById('judul_table').innerHTML="Search Hotel by Room Price";
        ...
        $('#kanan_table').append("<tr><th class='centered'>Name</th><th class='centered' colspan='3'>Action</th></tr>");
        console.log(server+'_data_hotel_cari1.php?min='+min+'&max='+max);
        $.ajax({url: server+'_data_hotel_cari1.php?min='+min+'&max='+max, data: "", dataType: 'json', success: function(rows){ 
          if(rows == null)
          {
            alert('Data Did Not Exist !');
          }
      ...
      function cari_hotel(tipe){ // PENCARIAN ANGKUTAN KOTA
          ...
          if (y == "") {          
            document.getElementById('modal_title').innerHTML="Info";
            document.getElementById('modal_body').innerHTML="Please fill in the form correctly";
            $('#myModal').modal('show'); 
            return;
          } else {
            $("#view_kanan_table").show();
      ...
      *********************************************************************************************************************************************************** */
      ...
      function route_sekitar(lat1,lng1,lat,lng) {
          ...
          if (lat1 == 0 || lat == 0 || lng1 == 0 || lng == 0) {          
            document.getElementById('modal_title').innerHTML="Info";
            document.getElementById('modal_body').innerHTML="An error has occurred, some have not been determined. <br> Reload data to perform this function";
            $('#myModal').modal('show'); 
            return;
          }
      ...
      function kuliner_sekitar(latitude,longitude,rad){ //KULINER SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_culinary_place.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#table_kanan_culinary').append("<tr><td>"+name+"</td><td width='50%'><a role='button' style='margin:5px' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin:5px' class='btn btn-success fa fa-info' title='info' onclick='modal_kuliner(\""+id+"\")'></a><a role='button' style='margin:5px' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a><a role='button' class='btn btn-success fa fa-taxi' title='angkot' style='margin:5px' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
      ...
      function masjid_sekitar(latitude,longitude,rad){ // MASJID SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_sekitar_worship_place.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
            ...
            $('#table_kanan_worship').append("<tr><td>"+name+"</td><td width='50%'><a role='button' style='margin:5px' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin:5px' class='btn btn-success fa fa-info' title='info' onclick='modal_masjid(\""+id+"\")'></a><a role='button' style='margin:5px' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a><a role='button' class='btn btn-success fa fa-taxi' title='angkot' style='margin:5px' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td></tr>");
          }//end for
        }});//end ajax  
      }
      ...
      function oleholeh_sekitar(latitude,longitude,rad){ // OLEH-OLEH SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_souvenir.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#table_kanan_souvenir').append("<tr><td>"+name+"</td><td width='50%'><a role='button' style='margin:5px' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin:5px' class='btn btn-success fa fa-info' title='info' onclick='modal_oo(\""+id+"\")'></a><a role='button' style='margin:5px' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a><a role='button' class='btn btn-success fa fa-taxi' title='angkot' style='margin:5px' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
      ...
      function tw_sekitar(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_tourism.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#table_kanan_tourism').append("<tr><td>"+name+"</td><td width='50%'><a role='button' style='margin:5px' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin:5px' class='btn btn-success fa fa-info'title='info' onclick='modal_tw(\""+id+"\")'></a><a role='button' style='margin:5px' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a><a role='button' class='btn btn-success fa fa-taxi' title='angkot' style='margin:5px' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
      ...
      function h_sekitar(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR ANGKOT
        ...
        $('#table_kanan_hotel').append("<tr><th class='centered'>Hotel Name</th><th class='centered'>Action</th></tr>"); 
          ...
          $.ajax({url: server+'_sekitar_hotel.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            ...
            $('#table_kanan_hotel').append("<tr><td>"+name+"</td><td width='50%'><a role='button' style='margin:5px' class='btn btn-success fa fa-road'title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin:5px' class='btn btn-success fa fa-info' title='info' onclick='modal_hotel(\""+id+"\")'></a><a role='button' style='margin:5px' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a><a role='button' class='btn btn-success fa fa-taxi' title='angkot' style='margin:5px' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
...
//            route_angkot(lat1,lng1,lat,lng,id_angkot,id
      ...
      *********************************************************************************************************************************************************** */
      ...
      function rekom_hotel(){
        ...
        if (j == 0) {          
          document.getElementById('modal_title').innerHTML="Info";
          document.getElementById('modal_body').innerHTML="Silahkan pilih tempat wisata terlebih dahulu";
          $('#myModal').modal('show'); 
          return;
        }
        $("#loader").show();
